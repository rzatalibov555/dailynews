...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="<?php echo base_url('public/admin/'); ?>assets/img/favicon/favicon.ico" />
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>assets/vendor/css/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>assets/vendor/css/theme-default.css"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?php echo base_url('public/admin/'); ?>assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="<?php echo base_url('public/admin/'); ?>assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">DailyNews</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to DailyNews Admin! 👋</h4>
                        ...
                        <form class="mb-3" action="<?php echo base_url('a_loginAct'); ?>" method="POST">
                            <div class="mb-3">
    ...
    <script src="<?php echo base_url('public/admin/'); ?>assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js">
    </script>
