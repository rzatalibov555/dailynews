...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo base_url('public/user/'); ?>img/favicon.ico" rel="icon">
    ...
    <link href="<?php echo base_url('public/user/'); ?>lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?php echo base_url('public/user/'); ?>css/style.css" rel="stylesheet">
</head>
...
<body>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        <a href=""><img src="<?php echo base_url('public/user/'); ?>img/news-110x110-1.jpg" class="w-100"  alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="<?php echo base_url('public/user/'); ?>img/news-110x110-2.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="<?php echo base_url('public/user/'); ?>img/news-110x110-3.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="<?php echo base_url('public/user/'); ?>img/news-110x110-4.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="<?php echo base_url('public/user/'); ?>img/news-110x110-5.jpg" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="<?php echo base_url('public/user/'); ?>img/news-110x110-1.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url('public/user/'); ?>lib/easing/easing.min.js"></script>
    <script src="<?php echo base_url('public/user/'); ?>lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="<?php echo base_url('public/user/'); ?>js/main.js"></script>
</body>
