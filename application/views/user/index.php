                        ...
                        <div class="position-relative overflow-hidden" style="height: 500px;">
                            ...
                            <div class="overlay">
                                <div class="mb-2">
                                    ...
                                    <a class="text-white" href=""><?php echo date("d-m-Y", strtotime($left_slider['n_date'])); ?></a>
                                </div>
                                <a class="h2 m-0 text-white text-uppercase font-weight-bold" href=""><?php echo $left_slider['n_title']; ?></a>
                            </div>
                        </div>
                    <?php } ?>
